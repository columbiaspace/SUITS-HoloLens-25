...
public class RockAnalyzer : MonoBehaviour
{
    ...
    private const int COMMAND_ROCK_ID = 31;
    private const int COMMAND_START = 27;
    private const int FIELDS_TO_REQUEST = 10;

    private readonly string[] propertyOrder = new string[]
    {
