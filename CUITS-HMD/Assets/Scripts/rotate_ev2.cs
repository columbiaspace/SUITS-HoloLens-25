...
public class rotate_ev2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (backend == null || backend.LatestData == null || backend.LatestData.eva2 == null || backend.LatestData.eva2.imu == null)
            {
                Debug.LogWarning("Waiting for backend heading data...");
                return;
            }

            float heading = backend.LatestData.eva2.imu.heading;
